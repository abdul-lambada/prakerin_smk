...
<head>
    ...
    <title>Tidak Diizinkan - {{ config('app.name', 'Prakerin SMK') }}</title>
...
@if(auth()->check())
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;">
        <div class="text-center text-white">
            ...
            <p class="lead text-white-50 mb-4">Anda tidak memiliki akses ke halaman ini.</p>
...
@else
    <div class="min-h-screen flex flex-col items-center justify-center px-4 text-center"
        ...
        <div class="text-primary text-sm font-semibold tracking-widest mb-2">ERROR 403</div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-900 mb-3">Akses tidak diizinkan</h1>
