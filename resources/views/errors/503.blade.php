...
<head>
    ...
    <title>Sedang Perawatan - {{ config('app.name', 'Prakerin SMK') }}</title>
...
@if(auth()->check())
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;">
        <div class="text-center text-white">
            ...
            <p class="lead text-white-50 mb-4">Sistem sedang dalam perawatan.</p>
            <p class="text-white-50 mb-4">Silakan coba lagi beberapa saat ke depan.</p>
...
@else
    <div class="min-h-screen flex flex-col items-center justify-center px-4 text-center"
        ...
        <div class="text-primary text-sm font-semibold tracking-widest mb-2">ERROR 503</div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-900 mb-3">Sistem sedang dalam perawatan</h1>
        <p class="text-sm text-slate-600 max-w-md mb-6">
            Kami sedang melakukan pemeliharaan sistem. Silakan coba lagi beberapa saat ke depan.
        </p>
