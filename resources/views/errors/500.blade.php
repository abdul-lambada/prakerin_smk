...
<head>
    ...
    <title>Terjadi Kesalahan - {{ config('app.name', 'Prakerin SMK') }}</title>
...
@if(auth()->check())
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;">
        <div class="text-center text-white">
            ...
            <p class="lead text-white-50 mb-4">Terjadi kesalahan pada sistem.</p>
            <p class="text-white-50 mb-4">Silakan coba beberapa saat lagi atau hubungi admin jika masalah berlanjut.</p>
...
@else
    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4 text-center"
        ...
        <div class="text-primary text-sm font-semibold tracking-widest mb-2">ERROR 500</div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-900 mb-3">Terjadi kesalahan pada sistem</h1>
        <p class="text-sm text-slate-600 max-w-md mb-6">
            Maaf, saat ini terjadi gangguan pada sistem. Silakan coba beberapa saat lagi.
        </p>
