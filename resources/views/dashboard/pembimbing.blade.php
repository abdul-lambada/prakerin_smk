...
<div class="row">
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="{{ route('pembimbing.monitoring.index') }}" class="text-decoration-none">
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Pesan Bimbingan Belum Dibaca</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $unread_bimbingan }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="{{ route('pembimbing.chat-dudi.index') }}" class="text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Pesan DUDI Belum Dibaca</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $unread_chat_dudi }}</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-comments fa-2x text-gray-300"></i>
                        </div>
