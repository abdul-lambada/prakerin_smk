...
use App\Http\Controllers\PembimbingMonitoringLapanganController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:pembimbing')->group(function () {
        ...
        Route::get('/pembimbing/monitoring-lapangan', [PembimbingMonitoringLapanganController::class, 'index'])->name('pembimbing.monitoring-lapangan.index');
        Route::get('/pembimbing/monitoring-lapangan/create', [PembimbingMonitoringLapanganController::class, 'create'])->name('pembimbing.monitoring-lapangan.create');
        Route::post('/pembimbing/monitoring-lapangan', [PembimbingMonitoringLapanganController::class, 'store'])->name('pembimbing.monitoring-lapangan.store');
        Route::get('/pembimbing/monitoring-lapangan/{monitoring}/edit', [PembimbingMonitoringLapanganController::class, 'edit'])->name('pembimbing.monitoring-lapangan.edit');
        Route::put('/pembimbing/monitoring-lapangan/{monitoring}', [PembimbingMonitoringLapanganController::class, 'update'])->name('pembimbing.monitoring-lapangan.update');
        Route::delete('/pembimbing/monitoring-lapangan/{monitoring}', [PembimbingMonitoringLapanganController::class, 'destroy'])->name('pembimbing.monitoring-lapangan.destroy');
